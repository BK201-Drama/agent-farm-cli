...
const wavePath = join(repoRoot, "test/fixtures/waves/polish-opencode-session-20260510.json");

describe("test/fixtures/waves/polish-opencode-session-20260510.json", () => {
  it("valid wave entries with plan and execute", () => {

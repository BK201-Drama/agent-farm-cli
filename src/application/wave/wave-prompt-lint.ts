...
export function lintWaveTaskPromptErrors(t: Record<string, unknown>, prefix: string): string[] {
  const errors: string[] = [];
...
export function lintWaveTaskPromptWarnings(t: Record<string, unknown>, prefix: string): string[] {
...
export function lintWaveTaskPromptStrictErrors(t: Record<string, unknown>, prefix: string): string[] {

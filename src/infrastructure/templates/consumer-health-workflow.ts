...
export function generateConsumerHealthWorkflowYaml(): string {
  return `# Generated by agent-farm project init. For cron + issue-on-fail, see:
# docs/integrations/github-actions-health.md (upstream agent-farm-cli repo).
name: Agent farm health
